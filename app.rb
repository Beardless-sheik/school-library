...
class App
  ...
  def list_all_people
    ...
    @people.map { |person| puts "[#{person.class}] Name: #{person.name}, ID: #{person.id}, Age: #{person.age}, Parent Permission: #{person.parent_permission}" }
    sleep 0.75
  end
  ...
  def create_student
    ...
    puts parent_permission 
    puts parent_permission == "n"
